...
class FeaturesDefinition
{
    ...
    public function all_available_features(): array
    {
        ...
        ) . '</p>', 'enabled' => $this->merchant_capabilities['installments'], 'buttons' => array(array('type' => 'secondary', 'text' => __('Configure', 'woocommerce-paypal-payments'), 'url' => 'https://www.paypal.com/businessmanage/preferences/installmentplan', 'showWhen' => 'enabled', 'class' => 'small-button'), array('type' => 'secondary', 'text' => __('Sign up', 'woocommerce-paypal-payments'), 'url' => 'https://www.paypal.com/businessmanage/preferences/installmentplan', 'showWhen' => 'disabled', 'class' => 'small-button'))), 'pwc' => array('title' => __('Pay with Crypto', 'woocommerce-paypal-payments'), 'description' => __('Enable customers to pay with cryptocurrency, and receive payments in USD in your PayPal balance.', 'woocommerce-paypal-payments'), 'enabled' => $this->merchant_capabilities['pwc'], 'buttons' => array(array('type' => 'secondary', 'text' => __('Configure', 'woocommerce-paypal-payments'), 'action' => array('type' => 'tab', 'tab' => 'payment_methods', 'section' => 'ppcp-pay-with-crypto'), 'showWhen' => 'enabled', 'class' => 'small-button'), array('type' => 'secondary', 'text' => __('Sign up', 'woocommerce-paypal-payments'), 'urls' => array('sandbox' => 'https://www.sandbox.paypal.com/bizsignup/add-product?product=CRYPTO_PYMTS', 'live' => 'https://www.paypal.com/bizsignup/add-product?product=CRYPTO_PYMTS'), 'showWhen' => 'disabled', 'class' => 'small-button'), array('type' => 'tertiary', 'text' => __('Learn more', 'woocommerce-paypal-payments'), 'url' => 'https://www.paypal.com/us/digital-wallet/manage-money/crypto', 'class' => 'small-button'))));
